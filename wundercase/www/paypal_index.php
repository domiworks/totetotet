<html lang="en"><head>
	...
	<input type="hidden" name="product_name" value="Flight Package - KL-JKT" /><!--Judul Flight JKT-KL-JKT; Hotel M KL--> 
	<input type="hidden" name="product_id" value="7a8srgs59" /><!--random code--> 
	<input type="hidden" name="product_quantity" value="1" />
	<input type="hidden" name="product_amount" value="1457" /><!--harga total--> 
