...
define('EMAIL_ADD', 'cool.of.to2@gmail.com'); // define any notification email
define('PAYPAL_EMAIL_ADD', 'cool.of.to2-facilitator@gmail.com'); // facilitator email which will receive payments change this email to a live paypal account id when the site goes live
...
switch($action){
	case "process": // case process insert the form data in DB and process to the paypal
		...
		$p->add_field('details', $_POST["details"]);
		...
		$p->add_field('phone', $_POST["payer_phone"]);
